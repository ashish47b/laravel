                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingText" placeholder="Ram Kumar">
                        ...
                        <div class="form-floating mb-4">
                            <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form-control" id="floatingPassword" placeholder="Password">
                        ...
                        <div class="form-floating mb-4">
                            <input type="password" class="form-control" id="confloatingPassword" placeholder="Confirm Password">
